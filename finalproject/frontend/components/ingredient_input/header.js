import { FormControl, FormLabel, FormControlLabel, RadioGroup, TextField, Radio, FormGroup, Checkbox } from '@mui/material';
import styles from './header.module.css'

export default function Header({ fieldChange, setMeasuringSystem, checkboxChange }) {
  return (
    <div className={styles.header}>
      ...
      <FormGroup className={styles.buttons}>
        ...
        <FormControlLabel control={<Checkbox />} name='ketogenic' label="Ketogenic" onChange={checkboxChange}/>
        <FormControlLabel control={<Checkbox />} name='glutenFree' label="Gluten Free" onChange={checkboxChange}/>
      </FormGroup>
    </div>
  )
}